...
const Pagination = ({ length = 6, urlPath }: PaginationProps) => {
	...
	const redirectToIndex = (indexPage: number) => {
		console.log("🚀 ~ file: Pagination.tsx:13 ~ redirectToIndex ~ redirectToIndex: indexPage", indexPage);
	}
	
	const redirectNextPage = () => {
		console.log("🚀 ~ file: Pagination.tsx:17 ~ redirectNextPage ~ redirectNextPage:");
	}

	const redirectBeforePage = () => {
		console.log("🚀 ~ file: Pagination.tsx:22 ~ redirectBeforePage ~ redirectBeforePage :");
	}

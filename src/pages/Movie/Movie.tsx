...
import { EditPencilSquare } from "../../resources/svg/GeneralIcons";

function Movie({}) {
  let { movieId } = useParams();
  const navigate = useNavigate();
  const imageURL =
    "https://i.pinimg.com/474x/b2/7b/7b/b27b7bbd39877d9ea00bd70c9e467677--godfather-movie-film-making.jpg";
  const logoURL =
    "https://e7.pngegg.com/pngimages/674/509/png-clipart-popcorn-cinema-systems-corp-film-reel-popcorn-logo-film.png";
  ...
  // const movieElement: Movies = {} as Movies;
  ...
  const redirectEditMovie = () => {
    navigate(`/edit-movie/movieId:${movieId}`);
  };
  ...
  const tempGenrs: GenreCat[] = [
    { id: getRandomNumber(), description: "Mafia" },
    { id: getRandomNumber(), description: "Drama" },
    { id: getRandomNumber(), description: "Crimen" },
  ];
    ...
    <Provider store={store}>
      <div className="flex w-full items-center justify-center">
        <div className="flex flex-col justify-center items-center ">
          <div className="flex ml-10 w-full mt-2 justify-end items-end">
            <button
              className="flex flex-row w-16 justify-between items-center"
              onClick={redirectEditMovie}
            >
              <LabelTitle title="Edit" />
              <EditPencilSquare color="#E1B53E" />
            </button>
          </div>
                ...
                <div className="w-full flex justify-end items-end">
                  <div className="w-3/4 flex flex-col justify-around items-center max-w-3xl borde text-white border-gray-200 rounded-lg ">
                    <div className="flex flex-col 2xl:w-3/5 xl:w-3/4 lg:w-3/4 md:w-5/5 mb-5 items-center justify-around">
                      <h1 className="text-3xl m-0 font-bold text-yellow-400">
                        {movie?.title}
                      </h1>
                      <div className="flex flex-row justify-end items-center mb-2">
                        <GenresList listItems={tempGenrs} />
                        <p className="text-zinc-200 text-xl px-1 py-1">
          ...
          <div
            id="comment-div"
            className="flex flex-col w-full justify-center items-center px-5"
          >
            <div
